...
AMovingPlatformRev1::AMovingPlatformRev1()
{
...
void AMovingPlatformRev1::BeginPlay()
{
    Super::BeginPlay();
...
void AMovingPlatformRev1::Tick(float DeltaTime)
{
...
void AMovingPlatformRev1::SetMovePlatform(bool IsMoving)
{
